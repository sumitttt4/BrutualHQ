      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold text-white mb-4">BrutualHQ</h3>
          ...
          <div>
            <h4 className="font-semibold text-white mb-4">Quick Links</h4>
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/motivation" className="text-slate-300 hover:text-white transition-colors">
                    Motivation
                  </Link>
                </li>
              </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/contact" className="text-slate-300 hover:text-white transition-colors">Contact Support</Link>
              </li>
            </ul>
          </div>
        </div>
